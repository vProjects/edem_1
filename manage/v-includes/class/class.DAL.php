<?php
	...
	class ManageContent_DAL
	{
        ...
        */
        ...
        function insertBlogtest($userid,$bloghead,$blogsub){
			$query = $conn->prepare("INSERT INTO `testbg` (`userid`,`bloghead`,`blogsub`) VALUES (?,?,?)");
			$values = array($userid,$bloghead,$blogsub);
			$query->execute($values);
			return $query->rowCount();
		}
